...
class VolleyingConsumer(_OTreeJsonWebsocketConsumer):
    ...
    def group_name(self, page, group_id, session_code, player_id):
        print("hello")
        return "volleying_session-" + str(session_code) + "_group-" + str(group_id)

    # parse messages of type channelsmin_message
    def volleying_message(self, event):
    ...
    def post_connect(self, page, group_id, session_code, player_id):
        ...
        with transaction.atomic():
            models_module = get_models_module('volleying')
